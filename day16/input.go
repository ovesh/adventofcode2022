...
const input0 = `Valve DB has flow rate=0; tunnels lead to valves AC, UN
...
Valve TS has flow rate=20; tunnel leads to valves NW
...
Valve IR has flow rate=13; tunnel leads to valves VR
